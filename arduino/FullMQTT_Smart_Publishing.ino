...
const char* SENSOR_GAS_CODE     = "GAS_MQ2_001";      // 💨 Gas MQ-2 (GPIO34)
...
bool shouldPublishSensors() {
  ...
  float currentTemp = (dht.getStatus() == 0) ? data.temperature : 25.0;
  float currentHumidity = (dht.getStatus() == 0) ? data.humidity : 50.0;
